...
export const temp06Schema = baseSchema.extend({
  // `email`, `address`, `phone` from baseSchema map to contact fields
  // website is plain text (not a URL), so no .url()
  website: z.string().optional(),
...
export type ITemp06ResumeData = z.infer<typeof temp06Schema>;

// ─── Template 07 Schema ────────────────────────────────────────────────────────

export const temp07Schema = baseSchema.extend({
  // `name`, `title`, `email`, `address`, `phone` from baseSchema
  // website is plain text — no .url()
  website: z.string().optional(),
...
export type ITemp07ResumeData = z.infer<typeof temp07Schema>;
...
export const AccomplishmentService = {
    ...
    createAccomplishment: async (data: Accomplishment) => {
    ...
    getAllAccomplishments: async (userId?: string) => {
    ...
    getAccomplishmentById: async (id: string, userId?: string) => {
    ...
    deleteAccomplishment: async (id: string, userId: string) => {
        const accomplishment = await prisma.accomplishment.findUnique({
            where: { id },
        });
